...
function ppm_quickstart_theme_files(){
    ...
    wp_enqueue_style( 'ppm-quickstart-theme-bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css', array(), '3.3.4' );
    wp_enqueue_style( 'ppm-quickstart-theme-fontawesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css', array(), '4.3.0' );
